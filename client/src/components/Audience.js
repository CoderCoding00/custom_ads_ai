...
const Audience = () => {
  ...
  async function onSubmit(event) {
    ...
    const response = await fetch("/components/Home", {
      ...
      body: JSON.stringtify({ product, feature, audience }),
    });
          ...
          <Col>
            <Card className="card-post">
              ...
              <Card.Body>
                ...
                <Card.Text>What is your product?</Card.Text>
                <Form>
                  <Form.Group>
          ...
          <Col>
            <Card className="card-post">
              ...
              <Card.Body>
                ...
                <Card.Text>Who is your target audience?</Card.Text>
                <Form>
                  <Form.Group>
          ...
          <Col>
            <Card className="card-post">
              ...
              <Card.Body>
                ...
                <Card.Text>What are 3 key features?</Card.Text>
                <Form>
                  <Form.Group>
